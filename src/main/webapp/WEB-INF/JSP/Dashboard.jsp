...
<html lang="en">
            ...
            <div class="page-content">
                        ...
                        <div class="panel panel-primary animated zoomIn xn-drop-left xn-panel-dragging">
                            ...
                            <div class="panel-body list-group list-group-contacts scroll" style="height: 200px;">
                                <a href="#" class="list-group-item">
                                    ...
                                    <img src="<c:url value="/Resources/Images/default_avatar.png" />" class="pull-left" alt="John Doe"/>
                                    <span class="contacts-title">John Doe</span>
                                    <p>Praesent placerat tellus id augue condimentum</p>
                                </a>
                                <a href="#" class="list-group-item">
                                    <div class="list-group-status status-away"></div>
                                    <img src="<c:url value="/Resources/Images/default_avatar.png" />" class="pull-left" alt="Dmitry Ivaniuk"/>
                                    <span class="contacts-title">Dmitry Ivaniuk</span>
                                    <p>Donec risus sapien, sagittis et magna quis</p>
                                </a>
                                <a href="#" class="list-group-item">
                                    <div class="list-group-status status-away"></div>
                                    <img src="<c:url value="/Resources/Images/default_avatar.png" />" class="pull-left" alt="Nadia Ali"/>
                ...
                <!-- START WIDGETS -->                    
                    ...
                    <div class="row">
                        <div class="col-md-12">                        
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Visitor Map</h3>
                    ...
                    <!-- START SIMPLE DATATABLE -->
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Recent Visitors</h3>   
    ...
    <!-- START SCRIPTS -->
        ...
        <script type="text/javascript" src="<c:url value="/Resources/JS/plugins/jvectormap/jquery-jvectormap-world-mill.js" />"></script>
        -->
